        ...
        <>
            <div className="flex flex-col items-center w-4/12 text-center relative" key={wine.id}>
                <div className="absolute right-0 top-0">
                    <button className="inline-flex items-center justify-center w-8 h-8 mr-2 text-pink-100 transition-colors duration-150 bg-red-600 hover:bg-red-700 rounded-lg focus:shadow-outline">
