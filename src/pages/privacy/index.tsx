...
<div className="
  ...
  <h1 className="font-montserrat text-gray-600 text-3xl mt-8" >PRIVACY STATEMENT</h1>
  ...
  <h1 className="font-montserrat text-gray-600 text-3xl mt-8" >PERSONAL INFORMATION</h1>
  <p  className="font-montserrat text-gray-600 text-xl text-justify mt-6">
